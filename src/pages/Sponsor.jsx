      ...
      <div className="prospectus-container">
        <main className="prospectus-main">
          <section className="prospectus-section header">
            ...
            <p>
              Join us in shaping the future of business resilience in Africa and
              beyond. Discover the benefits of being a sponsor at this premier
              event set in the picturesque coastal area of Hammamet, Tunisia.
            </p>
          </section>
          ...
          <section className="prospectus-section footer">
            ...
            <p>
              Join the ranks of our esteemed sponsors and make a lasting impact
              at the ADAPT AFRICA Congress.
            </p>
          </section>
